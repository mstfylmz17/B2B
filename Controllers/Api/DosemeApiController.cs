...
{
    public class DosemeApiController : Controller
    {
        private readonly Context c;
        public DosemeApiController(Context context)
        {
            c = context;
        }
        [HttpPost]
        ...
        {
            var veri = c.DosemeIsEmirleris.Where(v => v.Durum == true && v.GorulduMu != true).OrderByDescending(v => v.ID).ToList();
        ...
        {
            var veri = c.DosemeIsEmirleris.Where(v => v.Durum == true && v.GorulduMu == true && (v.KalanAdet > 0 ||v.IslemdekiAdet>0)&& (v.BitirmeDurum != true || (v.BitirmeDurum == true && v.GelenAdet != v.SiparisAdet))).OrderByDescending(v => v.ID).ToList();
            List<DtoDepoIsEmirleri> ham = new List<DtoDepoIsEmirleri>();
            foreach (var x in veri)
            {
                var sipic = c.SiparisIceriks.FirstOrDefault(v => v.ID == x.SiparisIcerikID);
        ...
        {
            var veri = c.DosemeIsEmirleris.Where(v => v.Durum == true && v.GorulduMu == true && v.BitirmeDurum == true).OrderByDescending(v => v.ID).ToList();
            List<DtoDepoIsEmirleri> ham = new List<DtoDepoIsEmirleri>();
            foreach (var x in veri)
            {
                var sipic = c.SiparisIceriks.FirstOrDefault(v => v.ID == x.SiparisIcerikID);
        ...
        {
            var veri = c.DosemeIsEmirleris.Where(v => v.Durum == true && v.GorulduMu == true && v.BitirmeDurum == false && v.KalanAdet > 0).OrderByDescending(v => v.ID).ToList();
            List<DtoDepoIsEmirleri> ham = new List<DtoDepoIsEmirleri>();
            foreach (var x in veri)
            {
                var sipic = c.SiparisIceriks.FirstOrDefault(v => v.ID == x.SiparisIcerikID);
        ...
        {
            var veri = c.DosemeIsEmirleris.Where(v => v.Durum == true && v.GorulduMu == true && v.BitirmeDurum == false && v.BaslamaDurum == true && v.IslemdekiAdet > 0).OrderByDescending(v => v.ID).ToList();
            List<DtoDepoIsEmirleri> ham = new List<DtoDepoIsEmirleri>();
            foreach (var x in veri)
            {
                var sipic = c.SiparisIceriks.FirstOrDefault(v => v.ID == x.SiparisIcerikID);
        ...
        {
            var veri = c.DosemeIsEmirleris.Where(v => v.Durum == true && v.GorulduMu == true && v.BitirmeDurum == false && (v.KalanAdet > 0 || v.IslemdekiAdet > 0) && v.GidenAdet > 0).OrderByDescending(v => v.ID).ToList();
            List<DtoDepoIsEmirleri> ham = new List<DtoDepoIsEmirleri>();
            foreach (var x in veri)
            {
                var sipic = c.SiparisIceriks.FirstOrDefault(v => v.ID == x.SiparisIcerikID);
        ...
        public IActionResult Okundu([FromBody] List<int> selectedIds)
        {
            ...
            {
                var isemri = c.DosemeIsEmirleris.FirstOrDefault(v => v.ID == id);
        ...
        [HttpPost]
        public IActionResult DosemeAl([FromBody] List<SelectedItem> selectedItems)
        {
            HttpContext.Request.Cookies.TryGetValue("VNNCerez", out var Cerez);
            int kulid = Convert.ToInt32(Cerez);
            var result = new { status = "error", message = "İşlem Başarısız..." };
            if (selectedItems != null)
            {
                foreach (var x in selectedItems)
                {
                    ...
                    var isemri = c.DosemeIsEmirleris.FirstOrDefault(v => v.ID == x.Id);
                    if (isemri.GelenAdet >= miktar && (isemri.KalanAdet >= miktar))
                    {
                        ...
                        if (sipic.Miktar >= miktar)
                        {
                            ...
                            c.SaveChanges();
                            result = new { status = "success", message = "Döşemeye Alma Başarılı..." };
                        }
                        else
                        {
        ...
        [HttpPost]
        public IActionResult DosemeCikar([FromBody] List<SelectedItem> selectedItems)
        {
            HttpContext.Request.Cookies.TryGetValue("VNNCerez", out var Cerez);
            int kulid = Convert.ToInt32(Cerez);
            var result = new { status = "error", message = "İşlem Başarısız..." };
            if (selectedItems != null)
            {
                foreach (var x in selectedItems)
                {
                    ...
                    if (isemri.GelenAdet >= miktar && ((isemri.IslemdekiAdet) >= miktar))
                    {
                        ...
                        f.AmbalajSevk(x.Id, kulid, "Döşeme", miktar);
                        isemri.IslemdekiAdet -= miktar;
                        ...
                        c.SaveChanges();
                        result = new { status = "success", message = "Döşemeden Çıkarma Başarılı..." };
                    }
                    else
                    {
                        result = new { status = "error", message = "Kalan Miktar Kabul Edilen Miktardan Fazla Olamaz..." };
        ...
        {
            var depois = c.DosemeIsEmirleris.Where(v => v.Durum == true && v.GelenAdet > 0 && v.GelenTarih.Value > DateTime.Today).ToList();
            List<DtoDepoIsEmirleri> ham = new List<DtoDepoIsEmirleri>();
            foreach (var x in depois)
            {
                ...
                list.GidenAdet = Convert.ToInt32(x.GidenAdet).ToString();
                list.KalanAdet = Convert.ToInt32(x.SiparisAdet - (x.GidenAdet)).ToString();
                if (x.GorenPersonel != null && x.GorenPersonel > 0) if (x.GorenPersonel != null && x.GorenPersonel > 0) list.GorenKullanici = c.Kullanicis.FirstOrDefault(v => v.ID == x.GorenPersonel).KullaniciAdi.ToString(); else list.GorenKullanici = ""; else list.GorenKullanici = "";
                list.OkunmaTarih = Convert.ToDateTime(x.OkunmaTarih).ToString("dd/MM/yyyy");
                list.BaslangicTarihi = Convert.ToDateTime(x.BaslangicTarihi).ToString("dd/MM/yyyy");
                list.BitisTarihi = Convert.ToDateTime(x.BitisTarihi).ToString("dd/MM/yyyy");
        ...
        {
            var depois = c.DosemeIsEmirleris.Where(v => v.Durum == true && v.GidenAdet > 0 && v.BaslangicTarihi.Value > DateTime.Today).ToList();
            List<DtoDepoIsEmirleri> ham = new List<DtoDepoIsEmirleri>();
            foreach (var x in depois)
            {
                var sipic = c.SiparisIceriks.FirstOrDefault(v => v.ID == x.SiparisIcerikID);
        ...
        {
            var depois = c.DosemeIsEmirleris.Where(v => v.Durum == true && v.GelenAdet > 0 && v.GelenTarih.Value > DateTime.Now.AddDays(-7)).ToList();
            List<DtoDepoIsEmirleri> ham = new List<DtoDepoIsEmirleri>();
            foreach (var x in depois)
            {
                var sipic = c.SiparisIceriks.FirstOrDefault(v => v.ID == x.SiparisIcerikID);
        ...
        {
            var depois = c.DosemeIsEmirleris.Where(v => v.Durum == true && v.GidenAdet > 0 && v.BaslangicTarihi.Value > DateTime.Now.AddDays(-7)).ToList();
            List<DtoDepoIsEmirleri> ham = new List<DtoDepoIsEmirleri>();
            foreach (var x in depois)
            {
                var sipic = c.SiparisIceriks.FirstOrDefault(v => v.ID == x.SiparisIcerikID);
        ...
        {
            var depois = c.DosemeIsEmirleris.Where(v => v.Durum == true && v.GelenAdet > 0 && v.GelenTarih.Value.Month == DateTime.Now.Month).ToList();
            List<DtoDepoIsEmirleri> ham = new List<DtoDepoIsEmirleri>();
            foreach (var x in depois)
            {
                var sipic = c.SiparisIceriks.FirstOrDefault(v => v.ID == x.SiparisIcerikID);
        ...
        {
            var depois = c.DosemeIsEmirleris.Where(v => v.Durum == true && v.GidenAdet > 0 && v.BaslangicTarihi.Value.Month == DateTime.Now.Month).ToList();
            List<DtoDepoIsEmirleri> ham = new List<DtoDepoIsEmirleri>();
            foreach (var x in depois)
            {
                var sipic = c.SiparisIceriks.FirstOrDefault(v => v.ID == x.SiparisIcerikID);
        ...
        {
            var depois = c.DosemeIsEmirleris.Where(v => v.Durum == true && v.GelenAdet > 0 && v.GelenTarih.Value.Year == DateTime.Now.Year).ToList();
            List<DtoDepoIsEmirleri> ham = new List<DtoDepoIsEmirleri>();
            foreach (var x in depois)
            {
                var sipic = c.SiparisIceriks.FirstOrDefault(v => v.ID == x.SiparisIcerikID);
        ...
        {
            var depois = c.DosemeIsEmirleris.Where(v => v.Durum == true && v.GidenAdet > 0 && v.BaslangicTarihi.Value.Year == DateTime.Now.Year).ToList();
            List<DtoDepoIsEmirleri> ham = new List<DtoDepoIsEmirleri>();
            foreach (var x in depois)
            {
                var sipic = c.SiparisIceriks.FirstOrDefault(v => v.ID == x.SiparisIcerikID);
